describe('den Datenschutzerklaerungshacken nicht zugestimmt worden, um zu sehen, ob eine Exception geworfen wird.', function() {

  beforeAll(function() {
    console.log('Test Case: Exception Throw, wenn Datenschutzerklaerungshacken nicht zugestimmt?');
  });
  ...
  it('sind Exceptions aufgetreten?', function() {
    expect(browser.getCurrentUrl()).toEqual("http://localhost/bewerberportal.html?absenden=keinezustimmungderdaten");
  });
});
