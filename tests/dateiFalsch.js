describe('die Bewerbungsunterlagen sind keine PDF-Dateien, um zu sehen, ob eine Exception geworfen wird.', function() {

  beforeAll(function() {
    console.log('Test Case: Exception Throw, wenn Bewerbungsunterlagen keine PDF-Dokumente sind?');
  });

  afterAll(function() {
    console.log('\nDer Bewerbungsablauf wurde abgebrochen, da dem Datenschutzerklaerungshacken nicht zugestimmt worden ist. (Erfolgreicher Test)\n');
  });
  ...
  it('die Bewerbungsunterlagen anklicken', function() {
    ...
    bewerbungsUnterlagen.sendKeys('C://Users/User/Desktop/BAM - 1 Semester/SWP/Bewerberportal/filesForTest/testCase.txt');
    browser.sleep(6000);
  });
  ...
  it('sind Exceptions aufgetreten?', function() {
    expect(browser.getCurrentUrl()).toEqual("http://localhost/bewerberportal.html?absenden=keinepdf");
  });
});
